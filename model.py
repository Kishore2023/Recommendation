...
#a = pickle.dump(anime, open('Order1.pkl','wb'))

#b = anime["Order1"].values

#c = anime.to_dict()

#d = pickle.dump(anime.to_dict(), open('Order1.pkl','wb'))

#e = pickle.dump(cosine_sim_matrix, open('similarity.pkl','wb'))

#anime.iloc[120].Order1
